...
export default function Calculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-600 dark:bg-gray-900">
      <Card className="w-full max-w-md [box-shadow:0px_0px_20px_black] p-5 bg-gray-400 dark:bg-gray-800 shadow-lg rounded-lg">
        <CardHeader>
